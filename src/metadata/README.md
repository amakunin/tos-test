 ...
 * [tos-test.yml](tos-test.yml)
     * Determines how your purl.obolibrary.org/obo/tos-test/ redirects will be handled
     ...
     * Paste in the contents of [tos-test.yml](tos-test.yml)
 ...
 * [tos-test.md](tos-test.md)
     ...
     * Paste in the contents of [tos-test.md](tos-test.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
